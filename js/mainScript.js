    ...
    function (result) {
        ...
        api.call("getScannedProduct", function(res) {
          ...
          if (res[0].imageURL != "" && res[0].imageURL != null) {
            ...
            if (res[0].Discount > 0) {
              html += "<br /><div style='float:left;margin-top:5px;'><span style='color:red;'><b>" + res[0].Discount + "% </b></span><span style='text-decoration:line-through;'>" + (parseFloat(res[0].SalesPrice) * 1).toLocaleString("nl-NL",{ style: 'currency', currency: "EUR" }) + "</span>&nbsp;&nbsp;";
              html += "<span>" + (parseFloat(res[0].realPrice) * 1).toLocaleString("nl-NL",{ style: 'currency', currency: "EUR" }) + "</span></div>";
            } else {
              html += "<br /><div style='float:left;margin-top:5px;'><span>" + (parseFloat(res[0].realPrice) * 1).toLocaleString("nl-NL",{ style: 'currency', currency: "EUR" }) + "</span></div>";
            }
            html += "</div>";
            $("#asc_body").html("");
